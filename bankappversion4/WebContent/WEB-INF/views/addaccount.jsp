...
<div class="sidenav">
	...
	Enter account type: <form:input path="accountType"/><form:errors path="accountType" class="error"/><br/>
	Enter blocked: <form:input path="blocked"/><form:errors path="blocked" class="error"/><br/>
	Enter deleted: <form:input path="deleted"/><form:errors path="deleted" class="error"/><br/>
