...
<div class="row">
  ...
  <a href="admin/transaction" class="btn btn-primary btn-lg active" role="button">Transaction</a>
...
<a href="mgr/block" class="btn btn-primary btn-lg active" role="button">Block Account</a>
