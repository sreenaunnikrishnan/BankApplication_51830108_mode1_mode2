...
<div class="sidenav">
	...
	<div class="main">
	 ...
	 <form:hidden path="id"/> 
	  Enter account number: <form:input path="accountNumber"/><form:errors path="accountNumber" class="error"/><br/>
	...
	Enter postalCode: <form:input path="postalCode"/><form:errors path="postalCode" class="error"/><br/>
	Enter stateName: <form:input path="stateName"/><form:errors path="stateName" class="error"/><br/>
	...
	Enter block: <form:input path="block"/><form:errors path="block" class="error"/><br/>
